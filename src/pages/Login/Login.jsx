        ...
        <Text
          ...
          style={
            formTypes
              ? {
                  fontSize: "36px",
                  borderBottom: "13px solid #90844F",
                  cursor: "pointer",
                }
              : { fontSize: "36px", cursor: "pointer" }
          }
          onClick={() => setFormTypes(true)}
        >
          Login
        </Text>
        <Text
        ...
        {isImage && (
          <Faksi>
            <img
              src={LogoFaksi1}
              alt="Faksi 1"
              style={{ width: "570px", height: "334px" }}
            />
            <img
              src={LogoFaksi2}
              alt="Faksi 2"
              style={{ width: "468px", height: "229px" }}
            />
          </Faksi>
        )}
        {formTypes ? (
